...
<template>
    <div class="practice-section">
        ...
        <section style="margin-bottom: 20px">
            ...
            <input type="text" v-model.lazy="lazyText" placeholder="입력 후 Enter 또는 외부 클릭시 반영" />
            <p>
        ...
        <!-- .number 실습 -->
         ...
         <!-- .trim 수식어 실습 -->
          <section>
            ...
            <input type="text" v-model.trim="userEmail" placeholder="앞뒤 공백을 포함해 보세요" />
            <p>
          ...
          <!-- 수식어 체이닝 (Chaining) 실습 -->
           <section>
            ...
            <input type="text" v-model.trim.number="price" placeholder="앞뒤 공백 제거 + Number 타입 변환" />
            <p>
