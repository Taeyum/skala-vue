...
<template>
  <div class="practice-section">
    ...
    <a href="https://www.naver.com" @click.prevent="handleLink">네이버로 이동</a>

    <h3>2) .stop (이벤트 버블링 막기)</h3>
    <div @click="handleBox" style="padding: 20; background-color: #eee">
    ...
    <h3>3) .capture (캡처링)</h3>
    <div @click.capture="handleBox" style="padding: 20; background-color: #eee">
      <p>부모 영역 (클릭 시 alert 발동)</p>
      <button @click="handleChild3">캡처링 발생 버튼</button>
    </div>
  </div>
</template>
